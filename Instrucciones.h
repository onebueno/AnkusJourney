...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(110, 216);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(47, 17);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Mover";
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Size = System::Drawing::Size(193, 149);
			...
			this->pictureBox2->Location = System::Drawing::Point(346, 124);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(125, 89);
			...
			this->label2->Location = System::Drawing::Point(385, 216);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(49, 17);
			this->label2->TabIndex = 3;
			this->label2->Text = L"Atacar";
			// 
			// Instrucciones
			// 
